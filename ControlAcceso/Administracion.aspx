...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function deshabilitarMensajeCorreo() {
            var value = document.getElementById("<%=ddlEstado.ClientID%>");
            var gettext = value.options[value.selectedIndex].text;
            if (gettext != "Autorizado") {
                var valueddl_2 = document.getElementById("<%=ddlMensajeCorreo.ClientID%>");
                valueddl_2.disabled = true;
                valueddl_2.selectedIndex = 0;
            }
            else {
                var valueddl_2 = document.getElementById("<%=ddlMensajeCorreo.ClientID%>");
                valueddl_2.disabled = false;
            }
        }

        function CambiaMensajeCorreoCheck(obj) {
            if (obj.checked) {                
                document.getElementById('<%=PanelMensajeCorreo.ClientID%>').style.display = 'block';                
            } else {                
                document.getElementById('<%=PanelMensajeCorreo.ClientID%>').style.display = 'none';
            }
        }

        function deshabilitarMensajeCorreo_Masivo() {
            var value = document.getElementById("<%=ddlEstado_1.ClientID%>");
            var gettext = value.options[value.selectedIndex].text;
            if (gettext != "Autorizado") {
                var valueddl_2 = document.getElementById("<%=ddlMensajeCorreoMasivo.ClientID%>");
                valueddl_2.disabled = true;
                valueddl_2.selectedIndex = 0;
            }
            else {
        ...
        function CheckMasivoMensaje(obj) {
            if (obj.checked) {
                document.getElementById('<%=PanelMensajeCorreoMasivo.ClientID%>').style.display = 'block';
            } else {
                document.getElementById('<%=PanelMensajeCorreoMasivo.ClientID%>').style.display = 'none';
            }
        }
                        ...
                        <div class="body">                            
                            <div class="control-group row">
                                ...
                                <div class="col-xs-auto col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <asp:DropDownList ID="ddlEstado_1" runat="server" CssClass="form-control" required data-style="btn-info" onchange="deshabilitarMensajeCorreo_Masivo()">
                                    </asp:DropDownList>
                                    <br />
                                </div>
                                <div class="col-xs-auto col-sm-12 col-md-12 col-lg-12">
                                    <asp:CheckBox ID="CheckBoxEnvioCorreo" runat="server" Text="Enviar correo" onclick="javascript:CheckMasivoMensaje(this)" ClientIDMode="Static"/>
                            ...
                            <br />
                            <asp:Panel ID="PanelMensajeCorreoMasivo" runat="server" >
                            <div class="control-group row">
                                <div class="col-xs-auto col-sm-12 col-md-12 col-lg-12">
                                    <label for="ddlMensajeCorreoMasivo">Opción Mensaje Correo</label>
                                    <asp:DropDownList ID="ddlMensajeCorreoMasivo" runat="server" CssClass="form-control" data-style="btn-info">
                                        <asp:ListItem>--</asp:ListItem>
                                        <asp:ListItem>Autorización, solo hasta anden de carga, personal sin tica no puede ingresar a Bodegas</asp:ListItem>
                                        <asp:ListItem>Autorización, solo a 2do piso (Labores Administrativas)</asp:ListItem>
                                        <asp:ListItem>Autorización por DGAC</asp:ListItem>
                                    </asp:DropDownList>
                                    <br />
                                </div>
                            </div>
                        ...
                        <div class="body">
                            <div class="control-group row">
                                ...
                                <div class="col-xs-auto col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <asp:DropDownList ID="ddlEstado" runat="server" CssClass="form-control" required data-style="btn-info" onchange="deshabilitarMensajeCorreo()">
                                    </asp:DropDownList>
                                    <br />
                                </div>
                                <div class="col-xs-auto col-sm-12 col-md-12 col-lg-12">

                                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Enviar correo" onclick="javascript:CambiaMensajeCorreoCheck(this)" ClientIDMode="Static"/>
                            ...
                            <asp:Panel ID="PanelMensajeCorreo" runat="server">
                            <div class="control-group row">
                                <div class="col-xs-auto col-sm-12 col-md-12 col-lg-12">
                                    <label for="ddlMensajeCorreo">Opción Mensaje Correo</label>
                                    <asp:DropDownList ID="ddlMensajeCorreo" runat="server" CssClass="form-control" data-style="btn-info">
                                        <asp:ListItem>--</asp:ListItem>
                                        <asp:ListItem>Autorización, solo hasta anden de carga, personal sin tica no puede ingresar a Bodegas</asp:ListItem>
                                        <asp:ListItem>Autorización, solo a 2do piso (Labores Administrativas)</asp:ListItem>
                                        <asp:ListItem>Autorización por DGAC</asp:ListItem>
