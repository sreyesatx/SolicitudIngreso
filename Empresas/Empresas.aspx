<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="Empresas.aspx.cs" Inherits="SistemaSolicitudIngreso.Empresas.Empresas" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="shadowBox">
                        <div class="page-container">
                            <div class="container">
                                <div class="jumbotron">
                                    <h1>Administración de solicitudes de ingreso por empresa</h1>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 ">
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvSolicitud" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" DataKeyNames="id_solicitud" EmptyDataText="No se encontraron solicitudes." DataSourceID="sdsSolicitudes" Style="font-size: 11px;" AllowPaging="True">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Solicitud">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="linkSolicitud" Visible='<%# ((string)Eval("descripcion_estado")) == "Creado" ? true : false  %>' runat="server" OnClick="btnOpenPopUp_Click" Text='<%# Eval("id_solicitud") %>' CommandArgument='<%# Eval("id_solicitud")%>' ToolTip="Administrar"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <br />
                                <br />
                                <asp:SqlDataSource ID="sdsSolicitudes" runat="server" ConnectionString='<%$ ConnectionStrings:SolicitudIngresoConnectionString %>' SelectCommand="sp_lista_solicitud_empresa" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                ...
                                <asp:SqlDataSource ID="sdsSolicitud" runat="server" ConnectionString='<%$ ConnectionStrings:SolicitudIngresoConnectionString %>' SelectCommand="sp_lista_solicitud_empresa" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter Name="Empresa" Type="String"></asp:Parameter>
                                        <asp:Parameter Name="FechaVisita" Type="String"></asp:Parameter>
                                        <asp:Parameter Name="NombreSolicitante" Type="String"></asp:Parameter>
                                ...
                                <asp:SqlDataSource ID="sdsUpdateSolicitud" runat="server" ConnectionString='<%$ ConnectionStrings:SolicitudIngresoConnectionString %>' SelectCommand="sp_update_solicitud_admin" SelectCommandType="StoredProcedure" UpdateCommand="sp_update_solicitud_admin_empresa" UpdateCommandType="StoredProcedure">
                                    <SelectParameters>
                    ...
                    <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
                        ...
                        <div class="body">
                            <div class="control-group row">
                                <div class="col-xs-auto col-sm-6 col-md-6 col-lg-6">
                                    <label for="ddlEstacionamiento"></label>
                                    <asp:DropDownList ID="ddlEstacionamiento" runat="server" CssClass="form-control" data-style="btn-info" Visible="false">
                                ...
                                <div class="col-xs-auto col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Enviar correo" Visible="false"/>
                                    <asp:TextBox ID="txtMensaje" runat="server" class="form-control" placeholder="Motivo Rechazo" AutoCompleteType="Disabled" MaxLength="500"></asp:TextBox>
                                    <br />
                                </div>
                                <div class="col-xs-auto col-sm-6 col-md-6 col-lg-6">
                                    <asp:CheckBox ID="CheckBoxRecurrente" runat="server" Text="Recurrente" Visible="false"/>
                                    </div>
                                <div class="col-xs-auto col-sm-6 col-md-6 col-lg-6">
                                    <label for="txtFecha"></label>
                                    <asp:TextBox ID="txtVigenciaHasta" runat="server" CssClass="form-control" AutoCompleteType="Disabled" MaxLength="10" Visible="false"></asp:TextBox>
                        ...
                        <div class="footer">
                            <asp:Button ID="btnEnviar" runat="server" Text="Enviar" class="btn btn-primary" OnClick="Enviar" OnClientClick="return validaDatos();" />
