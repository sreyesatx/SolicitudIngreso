<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="RegistroDiario.aspx.cs" Inherits="SistemaSolicitudIngreso.AccesoPeatones.RegistroDiario" %>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="text-align: left">
                            <div class="col-xs-auto col-sm-6 col-md-4 col-lg-3">
                                ...
                                <asp:DropDownList ID="ddlBuscaEmpresas" runat="server" CssClass="form-control" data-style="btn-info" AutoPostBack="true" OnTextChanged="ddlBuscaEmpresas_ddlChanged"></asp:DropDownList>
                            </div>                          
                            <div class="col-xs-auto col-sm-6 col-md-4 col-lg-3">
                                <label for="txtBuscaNombre">Nombre solicitante</label>
                                <asp:TextBox ID="txtBuscaNombre" runat="server" class="form-control" placeholder="Buscar por nombre" AutoCompleteType="Disabled" MaxLength="100" AutoPostBack="true"  OnTextChanged="txtBuscaNombre_TxtChanged"></asp:TextBox>
                            </div>
                            <div class="col-xs-auto col-sm-6 col-md-12 col-lg-3">
                                <label for="txtBuscaRut">Rut solicitante</label>
                                <asp:TextBox ID="txtBuscaRut" runat="server" class="form-control" AutoCompleteType="Disabled" placeholder="Buscar por rut" MaxLength="20" autofocus="autofocus" AutoPostBack="true" OnTextChanged="txtBuscaRut_TxtChanged"></asp:TextBox>
                            </div>
                            <div class="col-xs-auto col-sm-6 col-md-12 col-lg-3">
                                <label for="ddlTipoVisita">Patente</label>
                                <asp:TextBox ID="txtPatente" runat="server" class="form-control" AutoCompleteType="Disabled" placeholder="Buscar por rut" MaxLength="20" autofocus="autofocus" AutoPostBack="true" OnTextChanged="txtPatente_TxtChanged"></asp:TextBox>
                            </div>
                        </div>
                           <br />
                        <div class="row" style="text-align: left">          
                            <div class="col-xs-auto col-sm-6 col-md-4 col-lg-3">
                                <label for="ddlTipBusqueda">Tipo Busqueda</label>
                                <asp:DropDownList ID="ddlTipBusqueda" runat="server" CssClass="form-control" data-style="btn-info" AutoPostBack="true" OnTextChanged="ddlTipBusqueda_ddlChanged"></asp:DropDownList>
                            </div>
                            <div class="col-xs-auto col-sm-6 col-md-4 col-lg-3">
                                <label for="ddlTipBusqueda">Tipo Ingreso</label>
                                <asp:DropDownList ID="ddlTipoIngreso" runat="server" CssClass="form-control" data-style="btn-info" AutoPostBack="true" OnTextChanged="ddlTipoIngreso_ddlChanged"></asp:DropDownList>
                            </div>
                        </div>
                        <br />
                            ...
                            <div class="col-lg-12 ">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvSolicitud" runat="server" CssClass="table table-striped table-bordered table-hover" 
                                        ...
                                        Style="font-size: 11px;" AllowPaging="True" OnRowDataBound="gvSolicitud_RowDataBound"
                        ...
                        <br />
                        <br />
                        <asp:SqlDataSource ID="sdsSolicitudes" runat="server" ConnectionString='<%$ ConnectionStrings:SolicitudIngresoConnectionString %>' SelectCommand="Sp_consulta_Diaria_Administrador" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                ...
                                <asp:Parameter Name="TipoBusqueda" Type="String"></asp:Parameter>
