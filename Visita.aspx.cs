...
namespace SistemaSolicitudIngreso.Ingreso
{
    public partial class Visita : System.Web.UI.Page
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (valida == string.Empty)
                {
                    ...
                    string encargado, correo, copiaCorreo, mensaje, fechaVisita, empresa, motivo, autorizar, denegar, posdata, nombre_contacto, visitas, webRespuesta, solicitud, otro_indicar;
                    ...
                    fechaVisita = DateTime.Now.ToString();
                    ...
                    sdsSolicitud.InsertParameters.Add("cargo_solicitante", "Solicitud en porteria");
                    ...
                    limpiarFormulario();
                    ScriptManager.RegisterStartupScript(Page, this.GetType(), "alert", string.Format("swal('Solicitud creada correctamente, espere confirmación vía correo electrónico antes de llegar a portería.');", Title), true);
                }
                else
                {
        ...
        protected void limpiarFormulario()
        {
            ...
            rblAcompanante.SelectedValue = "0";
