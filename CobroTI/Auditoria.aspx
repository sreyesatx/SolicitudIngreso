<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="Auditoria.aspx.cs" Inherits="CobroTI_Auditoria" %>
                            ...
                            <div class="container">
                                ...
                                <div class="control-group row">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
                                        ...
                                        <asp:TextBox ID="txtMonto" runat="server" class="form-control" placeholder="" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
                                </div>
                                <br />
                                <div class="control-group row"> 
                                    <div class="correrderecha">
                                    <div class="btn-toolbar text-center well">
                                        <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" class="btn btn-primary" />                                                                        
                                        <asp:Button ID="bntExcel" runat="server" OnClick="ExportToExcel" Text="Excel" class="btn btn-success" visble="false" />                                                                        
                                        <asp:Button ID="btnGrabar" runat="server" OnClick="btnGrabar_Click" Text="Guardar" class="btn btn-warning" visble="false" /> 
                                    </div>   
                                        </div>                                                                                                                                         
                                </div>
                                <br />
